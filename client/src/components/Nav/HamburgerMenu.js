...
const HamburgerMenu = ({isOpen, setIsOpen }) => {
  return (
    <div className="fixed md:hidden top-2 right-2 sm:max-w-xl">
      <button className="relative w-10 h-10 text-gray-500 bg-white rounded-sm shadow-sm" onClick={() => setIsOpen(!isOpen)}>
